            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12" style="display: flex; align-items: center">
                <div class="wrap-text">
                    <div class="row" style="color: white;">
                        <br><br>
                        <h1 class="welcome-text"><b>Tentang Website Ini</b></h1>
                        <p class="paragraph-responsive">
                            Website ini merupakan salah satu sarana penelitian yang dikembangkan
                            oleh Aryo Bagas Pamungkas, seorang mahasiswa Universitas Pendidikan Indonesia
                            jurusan Ilmu Komputer. <br>
                            Tujuan dari pengembangan website ini adalah untuk mendeteksi kelemahan seseorang
                            dalam subjek-subjek kompetensi grammar bahasa inggris. Dengan harapan dapat membantu
                            proses evaluasi dan pembelajaran menjadi lebih terarah. Tes ini menggunakan
                            format tes TOEFL bagian structure tipe Error Identification. Anda dapat mengakses
                            tes tersebut dengan meng-klik tombol di bawah ini<br> <br>
                            @if(Auth::guest())
                            <a href="/cbt">
                                <button id="scrappingBtn" type="submit" name="submit" class="btn bg-color-secondary text-white float-start px-4 mt-2 fw-bold">Lakukan Tes Sekarang!</button>
                            </a>
                            @else
                            <a href="/cbt">
                                <button id="scrappingBtn" type="submit" name="submit" class="btn bg-color-secondary text-white float-start px-4 mt-2">Lakukan Tes Sekarang!</button>
                            </a>
                            @endif
                            <br><br><br><br><br>
                            Website ini dikembangkan dari website SmartEngTest.com yang memiliki layanan utama
                            untuk pembuatan soal bahasa inggris secara otomatis. <br>
                            Untuk dapat mengakses layanan SmartEngTest, Anda dapat menekan tombol di bagian bawah
                            halaman ini.
                        </p>
                    </div>
...
<div class="foooter" style="background-color: #F1F1F1;">
    <div class="row m-5 mb-0 mt-0">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 p-5 mt-5 hidden-items">
            ...
            &emsp;
            <a href="https://smartengtest.com" target="_blank">
